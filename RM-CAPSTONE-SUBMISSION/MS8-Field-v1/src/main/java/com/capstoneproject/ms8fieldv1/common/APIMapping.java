package com.capstoneproject.ms8fieldv1.common;

public class APIMapping {
    public static final String VERSION = "/v1";
    public static final String REQUEST_MAPPING_ENDPOINT_TICKET_SERVICE = "ticketservice";

    public static final String GET_MAPPING_ENDPOINT_VALIDATE_FIELD_BY_ID = "/validateFieldById";
    ...
    public static final String GET_MAPPING_ENDPOINT_GET_FIELD_BY_ID = "/getFieldById";
